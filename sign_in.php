...
<head>
    ...
    <style>
     #outer{
        background: radial-gradient(hsl(24, 100%, 50%),hsl(194, 100%, 50%),hsl(302, 100%, 50%));
        font-size: 20px;
        border-radius:8px;
        font-family: Georgia, 'Times New Roman', Times, serif; 
     }
     #outer:hover{
        background: radial-gradient(hsla(65, 92%, 46%, 0.835),hsl(234, 82%, 60%),hsl(9, 100%, 50%));
      } 
    </style>
</head>
<body>
...
<div id="outer">
    <div  class="container-fluid">
        ...
        <form action="sign_in_code.php" method="post" style="font: size 25px; ">
          <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="mb-3">
                        ...
                        <input type="password" name="password" placeholder="Password..." required="" required="" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                </div>
                <div class="col-sm-4"></div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
             <b>
                <p> <a href="changepass.php">Change Password</a> | <a href="registration.php">Not yet Registered</a>
                </p>
              </b>
            </div>
            <div class="col-sm-4"></div>
        ...
        <div class="row">
            <div class="col-sm-4"></div>
            <div class="col-sm-4">
                <p>© 2022 | Design by Trisha Mishra</p>
            </div>
            <div class="col-sm-4"></div>
        </div>
        <!-- //copyright -->
