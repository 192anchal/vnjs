        ...
        <div class="col-sm-2 bg-warning dashboard">
                <center> 
                    ...
                    <div class="col-sm-10 dashbody">
                        ...
                        <h3  class="col-sm-8 ms-auto pt-3"  style="text-align:center; color: black;">DASHBOARD </h3>
              ...
              <div class="row">
                <div class="col-sm-12">
                    <h2 style="text-align: center; margin-right:48px;">View Contact</h2>
                </div>
                <div class="col-sm-12">
                     <!--Table start-->
                     <table style="border:1px solid;"class="table align-middle mb-0 bg-white">
